...
public class AlertProvider extends ContentProvider {
  ...
  public static final Uri CONTENT_URI = Uri.parse("content://edu.ncsu.pgjalisa.soc_project1/alerts");
  ...
  static {
    ...
    uriMatcher.addURI("edu.ncsu.pgjalisa.soc_project1", "alerts", ALERTS);
    uriMatcher.addURI("edu.ncsu.pgjalisa.soc_project1", "alerts/#", ALERT_ID);
  }
  ...
  public Uri insert(Uri _uri, ContentValues _initialValues) {
    // Insert the new row, will return the row number if successful.
	  System.out.println(_initialValues.size());
