    ...
    new AlertDialog.Builder(context)
        ...
        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
          ...
          public void onClick(DialogInterface d, int which) {
            ...
            /* to store the alert entered into the content provider */
            ContentResolver cr = context.getContentResolver();
            ContentValues values = new ContentValues();
            values.put(AlertProvider.KEY_PLACE_LAT,latitude/1E6);
            values.put(AlertProvider.KEY_PLACE_LNG, longitude/1E6);
            values.put(AlertProvider.KEY_ALERT, input.getText().toString());
            cr.insert(AlertProvider.CONTENT_URI, values);
